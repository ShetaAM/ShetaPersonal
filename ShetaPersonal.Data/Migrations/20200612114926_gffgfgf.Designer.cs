...
namespace ShetaPersonal.Data.Migrations
{
    ...
    [Migration("20200612114926_gffgfgf")]
    partial class gffgfgf
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShetaPersonal.Data.Model.Entities.Setting", b =>
                {
                    ...
                    b.Property<string>("NotActiveImage")
                        .HasColumnType("nvarchar(200)")
                        .HasMaxLength(200);
            ...
            modelBuilder.Entity("ShetaPersonal.Data.Model.Entities.Rezome", b =>
                {
                    ...
                    b.HasOne("ShetaPersonal.Data.Model.Entities.Vaziyat", "Vaziyat")
                        .WithMany("Rezomes")
                        .HasForeignKey("VaziyatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
